...
cluster_names = {
    1: "\U0001F3E0 Budget Single",  # 🏠
    2: "\U0001F3A0 Spacious Family Home",  # 🏡
    3: "\U0001F31F Luxury Group Stay",  # 🌟
    4: "\U0001F4BC Economy Shared Room",  # 💼
    5: "\U0001F6CF Mid-Range Private Room"  # 🛏️
}
...
# 🔷 HEADER
# ============================= 
st.markdown("<h1 style='text-align: center;'>\U0001F3E1 Airbnb Recommendation System</h1>", unsafe_allow_html=True)
...
# 🔍 FILTER SECTION
# ============================= 
st.subheader("\U0001F50D Find your perfect Airbnb property")  # 🔍
...
with col3:
    num_bedrooms = st.number_input("🛏️ Min Bedrooms", min_value=0, max_value=int(df["bedrooms"].max()), value=1)  # 🛏️
with col4:
...
with sort_col1:
    sort_price = st.selectbox("Sort by Price", ["No Sort", "⬆️ Highest", "⬇️ Lowest"])  # ⬆️ ⬇️
with sort_col2:
...
# 🏠 TAMPILKAN PROPERTY
# ============================= 
st.subheader(f"🏘️ {len(filtered_df)} Properties Matching Your Criteria")  # 🏘️
